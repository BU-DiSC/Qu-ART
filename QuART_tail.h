...
namespace ART {
    ...
    class QuART_tail : public ART {
        ...
        private:
            ...
            // key is less than leaf value, we only need to change the fp path
            void insert_recursive_new(ART* tree, ArtNode* node, ArtNode** nodeRef, uint8_t key[], unsigned depth,
