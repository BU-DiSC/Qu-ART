...
namespace ART {
    ...
    void Node4::insertNode4OnlyUpdateFp(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 4) {
            // Insert element
            ...
            *nodeRef = newNode;
            ...
            memcpy(newNode->child, this->child, this->count * sizeof(uintptr_t));
            delete this;
            return newNode->insertNode16OnlyUpdateFp(tree, nodeRef, keyByte, child);
        }
    }

    void Node16::insertNode16OnlyUpdateFp(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 16) {
            // Insert element
            ...
            *nodeRef = newNode;
            ...
            newNode->count = this->count;
            delete this;
            return newNode->insertNode48OnlyUpdateFp(tree, nodeRef, keyByte, child);
        }
    }

    void Node48::insertNode48OnlyUpdateFp(ART* tree, ArtNode** nodeRef, uint8_t keyByte, ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 48) {
            // Insert element
            unsigned pos = this->count;
    ...
    void Node256::insertNode256OnlyUpdateFp(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        this->count++;
        this->child[keyByte] = child;
        ...
        // fp insert method for Node4
    void Node4::insertNode4AlwaysChangeFp(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ...
        if (this->count < 4) {
            ...
            *nodeRef = newNode;
            ...
            delete this;
            return newNode->insertNode16AlwaysChangeFp(tree, nodeRef, keyByte, child, depth_prev);
        }
    }

    // fp insert method for Node16
    void Node16::insertNode16AlwaysChangeFp(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child, size_t depth_prev) {
        // Insert leaf into inner node
        if (this->count < 16) {
            // Insert element
            ...
            *nodeRef = newNode;
            ...
            delete this;
            return newNode->insertNode48AlwaysChangeFp(tree, nodeRef, keyByte, child, depth_prev);
        }
    }

    // fp insert method for Node48
    void Node48::insertNode48AlwaysChangeFp(ART* tree, ArtNode** nodeRef, uint8_t keyByte, ArtNode* child, size_t depth_prev) {
       // Insert leaf into inner node
       if (this->count < 48) {
           // Insert element
           unsigned pos = this->count;
           ...
           *nodeRef = newNode;
           ...
           delete this;
           return newNode->insertNode256AlwaysChangeFp(tree, nodeRef, keyByte, child, depth_prev);
       }
    }

    // fp insert method for Node256
    void Node256::insertNode256AlwaysChangeFp(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child, size_t depth_prev) {
        // Insert leaf into inner node
        this->count++;
        this->child[keyByte] = child;
    ...
    void Node4::insertNode4OnlyUpdateFp2(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 4) {
            // Insert element
            ...
            *nodeRef = newNode;
            ...
            memcpy(newNode->child, this->child, this->count * sizeof(uintptr_t));
            delete this;
            return newNode->insertNode16OnlyUpdateFp2(tree, nodeRef, keyByte, child);
        }
    }

    void Node16::insertNode16OnlyUpdateFp2(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 16) {
            // Insert element
            ...
            *nodeRef = newNode;
            ...
            newNode->count = this->count;
            delete this;
            return newNode->insertNode48OnlyUpdateFp2(tree, nodeRef, keyByte, child);
        }
    }

    void Node48::insertNode48OnlyUpdateFp2(ART* tree, ArtNode** nodeRef, uint8_t keyByte, ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 48) {
            // Insert element
            unsigned pos = this->count;
            ...
            *nodeRef = newNode;
            ...
            delete this;
            return newNode->insertNode256OnlyUpdateFp2(tree, nodeRef, keyByte, child);
        }
    }

    void Node256::insertNode256OnlyUpdateFp2(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        this->count++;
        this->child[keyByte] = child;
        ...
        // fp insert method for Node4
    void Node4::insertNode4AlwaysChangeFp2(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 4) {
            // Insert element
            ...
            *nodeRef = newNode;
            ...
            delete this;
            return newNode->insertNode16AlwaysChangeFp2(tree, nodeRef, keyByte, child);
        }
    }

    // fp insert method for Node16
    void Node16::insertNode16AlwaysChangeFp2(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 16) {
            // Insert element
            ...
            *nodeRef = newNode;
            ...
            delete this;
            return newNode->insertNode48AlwaysChangeFp2(tree, nodeRef, keyByte, child);
        }
    }

    // fp insert method for Node48
    void Node48::insertNode48AlwaysChangeFp2(ART* tree, ArtNode** nodeRef, uint8_t keyByte, ArtNode* child) {
       // Insert leaf into inner node
       if (this->count < 48) {
           // Insert element
           unsigned pos = this->count;
           ...
           *nodeRef = newNode;
           ...
           delete this;
           return newNode->insertNode256AlwaysChangeFp2(tree, nodeRef, keyByte, child);
       }
    }

    // fp insert method for Node256
    void Node256::insertNode256AlwaysChangeFp2(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        this->count++;
        this->child[keyByte] = child;
    ...
    void Node4::insertNode4OnlyUpdateFpS(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 4) {
            // Insert element
    ...
    void Node16::insertNode16OnlyUpdateFpS(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
        ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 16) {
            // Insert element
    ...
    void Node48::insertNode48OnlyUpdateFpS(ART* tree, ArtNode** nodeRef, uint8_t keyByte, ArtNode* child) {
        // Insert leaf into inner node
        if (this->count < 48) {
            // Insert element
            unsigned pos = this->count;
