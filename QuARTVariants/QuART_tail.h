            ...
            void insert_recursive_tail(ART* tree, ArtNode* node, ArtNode** nodeRef, uint8_t key[], unsigned depth,
                ...
                if (isLeaf(node)) {
                    ...
                    *nodeRef = newNode;
                    ...
                    newNode->tailInsertNode4(this, nodeRef, existingKey[depth + newPrefixLength],
                                node, temp_fp_path, temp_fp_path_length, depth_prev);
                    newNode->tailInsertNode4(this, nodeRef, key[depth + newPrefixLength],
                    ...
                    if (mismatchPos != node->prefixLength) {
                        ...
                        *nodeRef = newNode;
                        ...
                        if (node->prefixLength < maxPrefixLength) {
                            ...
                            newNode->tailInsertNode4(this, nodeRef, node->prefix[mismatchPos], node,
                            ...
                            newNode->tailInsertNode4(this, nodeRef, minKey[depth + mismatchPos],
                                        node, temp_fp_path, temp_fp_path_length, depth_prev);
                ...
                switch (node->type) {
                    case NodeType4:
                        static_cast<Node4*>(node)->tailInsertNode4(this, nodeRef, key[depth],
                                    newNode, temp_fp_path, temp_fp_path_length, depth_prev);
                        break;
                    case NodeType16:
                        static_cast<Node16*>(node)->tailInsertNode16(this, nodeRef, key[depth],
                                    newNode, temp_fp_path, temp_fp_path_length, depth_prev);
                        break;
                    case NodeType48:
                        static_cast<Node48*>(node)->tailInsertNode48(this, nodeRef, key[depth],
                                    newNode, temp_fp_path, temp_fp_path_length, depth_prev);
                        break;
                    case NodeType256:
                        static_cast<Node256*>(node)->tailInsertNode256(this, nodeRef, key[depth],
                                    newNode, temp_fp_path, temp_fp_path_length, depth_prev);
                        break;
                }
            }            
