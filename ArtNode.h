/*
 * ArtNode and its derived classes for an Adaptive Radix Tree (ART)
 * implementation
 */
...
//          // Insert element
//          unsigned pos;
//          for (pos = 0; (pos < this->count) && (this->key[pos] < keyByte);
//          pos++); memmove(this->key + pos + 1, this->key + pos, this->count -
//          pos); memmove(this->child + pos + 1, this->child + pos,
...
//          memcpy(newNode->child, this->child, this->count *
//          sizeof(uintptr_t)); delete this; return newNode->insertNode16(tree,
//          nodeRef, keyByte, child);
//      }
//  }
=======
void Node4::insertNode4(ART* tree, ArtNode** nodeRef, uint8_t keyByte,
...
//          *nodeRef = newNode;
//          memcpy(newNode->child, this->child, this->count *
//          sizeof(uintptr_t)); for (unsigned i = 0; i < this->count; i++)
